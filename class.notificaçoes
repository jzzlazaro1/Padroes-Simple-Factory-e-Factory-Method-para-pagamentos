...
print("Classes 'EmailNotificacaoFactory', 'SMSNotificacaoFactory' e 'WhatsAppNotificacaoFactory' definidas com sucesso.")from abc import ABC, abstractmethod
class Notificacao(ABC):
    @abstractmethod
    def enviar(self, destino: str, mensagem: str) -> str:
        pass
...
print("Classes 'EmailNotificacaoFactory', 'SMSNotificacaoFactory' e 'WhatsAppNotificacaoFactory' definidas com sucesso.")
